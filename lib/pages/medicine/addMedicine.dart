                        ...
                        children: <Widget>[
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                labelStyle: TextStyle(
                                    color: focusNodeMedicineName.hasFocus
                                        ? mainColor
                                        : Colors.black),
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              validator: (val) =>
                                  val.isEmpty || int.parse(val) > 100
                                      ? 'Invalid value'
                                      : null,
                              decoration: InputDecoration(
                                labelText: "Stock",
                                labelStyle: TextStyle(
                                    color: focusNodeStock.hasFocus
                                        ? mainColor
                                        : Colors.black),
                                border: OutlineInputBorder(
                                  borderSide: BorderSide(color: Colors.black),
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              validator: (val) =>
                                  val.isEmpty || int.parse(val) > 10
                                      ? 'Invalid value'
                                      : null,
                              decoration: InputDecoration(
                                labelText: "Intake Dose",
                                labelStyle: TextStyle(
                                    color: focusNodeDose.hasFocus
                                        ? mainColor
                                        : Colors.black),
                                border: OutlineInputBorder(
                                  borderSide: BorderSide(color: Colors.black),
